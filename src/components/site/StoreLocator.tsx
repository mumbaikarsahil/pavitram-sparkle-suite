...
const DEFAULT_STORE_IMAGE = "https://mfdjlbvqfbujipihehpt.supabase.co/storage/v1/object/public/ecommerce-assets/banner_images/store-front.webp";
...
export const STORES_DATA = [
  { name: "Andheri (W)", address: "Viral Apartment, A Wing, 3rd Floor (No Lift), S.V. Road, Opp. Andheri Shoppers Stop, Above Hotel Radha Krishna, Andheri West, Mumbai - 400058", phone: "+91 8657003815", working_hours: "11:00 AM to 8:00 PM (All days open)", lat: 19.1136, lng: 72.8411, image: DEFAULT_STORE_IMAGE },
  { name: "Borivali (W)", address: "Shop No. 16, Sundar Vichar, Opp. Amar Jyoti Building & Bank of Baroda, Shimpoli Road, Kastur Park, Borivali (W), Mumbai - 400092", phone: "8657003816", working_hours: "11:00 AM to 8:00 PM (All days open)", lat: 19.2343, lng: 72.8427, image: DEFAULT_STORE_IMAGE },
  { name: "Navi Mumbai Vashi", address: "Shop No. 3, A Wing, Gagangiri CHS, Opp. Peshwai Sarees, Abhyudaya Bank Marg, Plot No. 47, Sector 17, Vashi, Navi Mumbai - 400703", phone: "8657003817", working_hours: "11:00 AM to 8:00 PM (All days open)", lat: 19.0745, lng: 72.9978, image: DEFAULT_STORE_IMAGE },
  { name: "Virar (W)", address: "Siddhi Manora, Near Desai Hospital, Beside Kamal Medical, Virar West, Maharashtra 401303", phone: "8657003819", working_hours: "11:00 AM to 8:00 PM (All days open)", lat: 19.4580, lng: 72.7938, image: DEFAULT_STORE_IMAGE },
  { name: "Ghatkopar (E)", address: "Shop No. 2, Madhav Apt., Jawahar Road, Next to Samrat Hotel, Ghatkopar East, Mumbai - 400077", phone: "+91 8657003849", working_hours: "11:00 AM to 8:00 PM (All days open)", lat: 19.0790, lng: 72.9080, image: DEFAULT_STORE_IMAGE },
  { name: "Breach Candy", address: "43, Bhulabhai Desai Marg, Breach Candy, Cumballa Hill, Mumbai, Maharashtra - 400026", phone: "8657003833", working_hours: "11:30 AM to 8:00 PM (All days open)", lat: 18.9722, lng: 72.8055, image: DEFAULT_STORE_IMAGE },
  { name: "Thane", address: "Inside Mahavir Jewellers, Pathare Bldg CHS, Near Canara Bank, Gokhale Road, Naupada, Thane (W) - 400602", phone: "8657003834", working_hours: "11:00 AM to 8:00 PM (All days open)", lat: 19.1973, lng: 72.9644, image: DEFAULT_STORE_IMAGE },
  { name: "Kurla", address: "Inside Ratnadeep Jewellers, 318, Yashodabai Shivkumar Chawl, Shop No. 1 & 2, Opp. New Mill Road, Kurla West, Mumbai - 400070", phone: "8657003830", working_hours: "11:00 AM to 8:00 PM (Thursday closed)", lat: 19.0726, lng: 72.8795, image: DEFAULT_STORE_IMAGE },
  { name: "Parel", address: "Inside Navaratna Jewellers, Shop No. 1, Saraf Building, Near Maharani Sarees, Dr. B. Ambedkar Road, Parel (E), Mumbai - 400012", phone: "8657003835", working_hours: "11:00 AM to 8:00 PM (Monday closed)", lat: 18.9953, lng: 72.8397, image: DEFAULT_STORE_IMAGE },
  { name: "Kamothe", address: "Inside Kalash Jewellers, Shop No. 15, Uma Shiv Corner CHS, Plot No. 22A, Sector 19, Kamothe, Navi Mumbai - 410209", phone: "8657000965", working_hours: "11:00 AM to 8:00 PM (Friday closed)", lat: 19.0251, lng: 73.0939, image: DEFAULT_STORE_IMAGE },
  { name: "Dombivli", address: "Inside M/s ShreeShri Devi Jewels India Pvt. Ltd., Shop No. 1, Ground Floor, Rakhi Apartment, Near Sarvesh H. Tilak Road, Dombivli, Thane - 421201", phone: "8657003848", working_hours: "11:00 AM to 8:00 PM (All days open)", lat: 19.2183, lng: 73.0867, image: DEFAULT_STORE_IMAGE },
  { name: "Badlapur", address: "Inside Bhagirathi Jewellers, Shop No. 4, Deepmani Apartment, Opp. Railway Gate, Badlapur, Thane, Maharashtra - 421503", phone: "8657000961", working_hours: "11:00 AM to 8:00 PM (Monday closed)", lat: 19.1551, lng: 73.2372, image: DEFAULT_STORE_IMAGE },
  { name: "Chakan", address: "Wafgaonkar Rajlaxmi Jewellers, Main Road, Manik Chowk, Chakan, Maharashtra 410501", phone: null, working_hours: null, lat: 18.7505, lng: 73.8567, image: DEFAULT_STORE_IMAGE },
  { name: "Ratnagiri", address: "Shop No. 6, 7, Kanhaiyalal Complex, opp. Bus Stand, Police Head Quarters, Ratnagiri, Maharashtra 415612", phone: null, working_hours: null, lat: 16.9902, lng: 73.3120, image: DEFAULT_STORE_IMAGE },
  { name: "Chhatrapati Sambhajinagar", address: "Veer Marg, Keli Bazar, Chhatrapati Sambhajinagar (Aurangabad), Maharashtra 431001", phone: null, working_hours: null, lat: 19.8762, lng: 75.3433, image: DEFAULT_STORE_IMAGE },
  // Parbhani flagged as Coming Soon
  { name: "Parbhani", address: "Near Gandhi Park Main Gate, Gandhi Park, Parbhani 431401, Maharashtra", phone: null, working_hours: null, lat: 19.2668, lng: 76.7748, isComingSoon: true, image: DEFAULT_STORE_IMAGE }
];
  ...
  return (
    <div className="w-full max-w-[1200px] mx-auto flex flex-col px-4 md:px-0">
      ...
      {displayStores.length === 0 && (
        <div className="text-center py-12 text-zinc-500 text-sm bg-white rounded-2xl border border-zinc-100">
